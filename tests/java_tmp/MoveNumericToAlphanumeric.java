...
public class MoveNumericToAlphanumeric {
	...
	public MoveNumericToAlphanumeric() {
		this.init();
	}
	...
	/* Functions */
	public int MoveNumericToAlphanumeric_ (int entry) {
		try {
		...
		if (!this.initialized) {
			...
			if (module.next == null) {
				this.cobolSetCancel ("MoveNumericToAlphanumeric", null, null);
			}
			module.setProgramId("MoveNumericToAlphanumeric");
			this.b_1.set(0);
	...
	public static void main(String[] args) {
		new MoveNumericToAlphanumeric().MoveNumericToAlphanumeric_(0);
	}
}
