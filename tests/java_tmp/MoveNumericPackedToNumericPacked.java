...
public class MoveNumericPackedToNumericPacked {
	...
	public MoveNumericPackedToNumericPacked() {
		this.init();
	}
	...
	/* Functions */
	public int MoveNumericPackedToNumericPacked_ (int entry) {
		try {
		...
		if (!this.initialized) {
			...
			if (module.next == null) {
				this.cobolSetCancel ("MoveNumericPackedToNumericPacked", null, null);
			}
			module.setProgramId("MoveNumericPackedToNumericPacked");
			this.b_1.set(0);
	...
	public static void main(String[] args) {
		new MoveNumericPackedToNumericPacked().MoveNumericPackedToNumericPacked_(0);
	}
