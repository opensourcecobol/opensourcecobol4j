...
public class MoveNumericToNumericPacked {
	...
	public MoveNumericToNumericPacked() {
		this.init();
	}

	private void init() {
		this.b_1 = new CobolDataStorage(5);
	...
	/* Functions */
	public int MoveNumericToNumericPacked_ (int entry) {
		try {
		...
		if (!this.initialized) {
			...
			if (module.next == null) {
				this.cobolSetCancel ("MoveNumericToNumericPacked", null, null);
			}
			module.setProgramId("MoveNumericToNumericPacked");
			this.b_1.set(0);
	...
	public static void main(String[] args) {
		new MoveNumericToNumericPacked().MoveNumericToNumericPacked_(0);
	}
}