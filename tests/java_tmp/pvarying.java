...
public class pvarying implements CobolRunnable {
  interface __B {
  ...
  int pvarying_ (int entry, AbstractCobolField... fields )
  {
    ...
    this.cobolPushCallStackList("pvarying");
  ...
  public void init()
  {
    try {
      ...
      c_1	= CobolFieldFactory.makeCobolField(1, "0", a_2);
