...
public class MoveNumericPackedToNumeric {
	...
	public MoveNumericPackedToNumeric() {
		this.init();
	}
	...
	/* Functions */
	public int MoveNumericPackedToNumeric_ (int entry) {
		try {
		...
		if (!this.initialized) {
			...
			if (module.next == null) {
				this.cobolSetCancel ("MoveNumericPackedToNumeric", null, null);
			}
			module.setProgramId("MoveNumericPackedToNumeric");
			this.b_1.set(0);
	...
	public static void main(String[] args) {
		new MoveNumericPackedToNumeric().MoveNumericPackedToNumeric_(0);
	}
}
