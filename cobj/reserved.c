...
static const struct cb_intrinsic_table function_list[] = {
    ...
    {"ATAN", 1, 1, CB_INTR_ATAN, "CobolIntrinsic.funcAtan", CB_CATEGORY_NUMERIC,
     0},
    {"BOOLEAN-OF-INTEGER", 2, 1, CB_INTR_BOOLEAN_OF_INTEGER, "CobolIntrinsic.funcBooleanOfInteger",
     CB_CATEGORY_NUMERIC, 0},
    ...
    {"CHAR-NATIONAL", 1, 1, CB_INTR_CHAR_NATIONAL, "CobolIntrinsic.funcCharNational",
     CB_CATEGORY_ALPHANUMERIC, 0},
    ...
    {"DISPLAY-OF", -1, 1, CB_INTR_DISPLAY_OF, "CobolIntrinsic.funcDisplayOf", CB_CATEGORY_ALPHANUMERIC,
     0},
    ...
    {"EXCEPTION-FILE-N", 0, 1, CB_INTR_EXCEPTION_FILE_N, "CobolIntrinsic.funcExceptionFileN",
     CB_CATEGORY_ALPHANUMERIC, 0},
    {"EXCEPTION-LOCATION", 0, 1, CB_INTR_EXCEPTION_LOCATION,
     "CobolIntrinsic.funcExceptionLocation", CB_CATEGORY_ALPHANUMERIC, 0},
    {"EXCEPTION-LOCATION-N", 0, 1, CB_INTR_EXCEPTION_LOCATION_N, "CobolIntrinsic.funcExceptionLocationN",
     CB_CATEGORY_ALPHANUMERIC, 0},
    ...
    {"HIGHEST-ALGEBRAIC", 1, 1, CB_INTR_HIGHEST_ALGEBRAIC, "CobolIntrinsic.funcHighestAlgebraic",
     CB_CATEGORY_NUMERIC, 0},
    {"INTEGER", 1, 1, CB_INTR_INTEGER, "CobolIntrinsic.funcInteger",
     CB_CATEGORY_NUMERIC, 0},
    {"INTEGER-OF-BOOLEAN", 1, 1, CB_INTR_INTEGER_OF_BOOLEAN, "CobolIntrinsic.funcIntegerOfBoolean",
     CB_CATEGORY_NUMERIC, 0},
    ...
    {"LENGTH-AN", 1, 1, CB_INTR_LENGTH_AN, "CobolIntrinsic.funcLength",
     CB_CATEGORY_NUMERIC, 0},
    {"LOCALE-COMPARE", -1, 1, CB_INTR_LOCALE_COMPARE, "CobolIntrinsic.funcLocaleCompare",
     CB_CATEGORY_ALPHANUMERIC, 0},
    ...
    {"LOWER-CASE", 1, 1, CB_INTR_LOWER_CASE, "CobolIntrinsic.funcLowerCase",
     CB_CATEGORY_ALPHANUMERIC, 1},
    {"LOWEST-ALGEBRAIC", 1, 1, CB_INTR_LOWEST_ALGEBRAIC, "CobolIntrinsic.funcLowestAlgebraic",
     CB_CATEGORY_NUMERIC, 0},
    ...
    {"NATIONAL-OF", -1, 1, CB_INTR_NATIONAL_OF, "CobolIntrinsic.funcNationalOf", CB_CATEGORY_ALPHANUMERIC,
     0},
    {"NUMVAL", 1, 1, CB_INTR_NUMVAL, "CobolIntrinsic.funcNumval",
     CB_CATEGORY_NUMERIC, 0},
    {"NUMVAL-C", 2, 1, CB_INTR_NUMVAL_C, "CobolIntrinsic.funcNumvalC",
     CB_CATEGORY_NUMERIC, 0},
    {"NUMVAL-F", 1, 1, CB_INTR_NUMVAL_F, "CobolIntrinsic.funcNumvalF", CB_CATEGORY_NUMERIC, 0},
    ...
    {"SQRT", 1, 1, CB_INTR_SQRT, "CobolIntrinsic.funcSqrt", CB_CATEGORY_NUMERIC,
     0},
    {"STANDARD-COMPARE", -1, 1, CB_INTR_STANDARD_COMPARE, "CobolIntrinsic.funcStandardCompare",
     CB_CATEGORY_ALPHANUMERIC, 0},
    ...
    {"TEST-NUMVAL", 1, 1, CB_INTR_TEST_NUMVAL, "CobolIntrinsic.funcTestNumval", CB_CATEGORY_NUMERIC, 0},
    {"TEST-NUMVAL-C", -1, 1, CB_INTR_TEST_NUMVAL_C, "CobolIntrinsic.funcTestNumvalC", CB_CATEGORY_NUMERIC,
     0},
    {"TEST-NUMVAL-F", 1, 1, CB_INTR_TEST_NUMVAL_F, "CobolIntrinsic.funcTestNumvalF", CB_CATEGORY_NUMERIC,
     0},
