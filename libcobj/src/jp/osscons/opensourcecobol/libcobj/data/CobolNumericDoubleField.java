...
public class CobolNumericDoubleField extends AbstractCobolField {
	...
	public CobolNumericDoubleField(int size, CobolDataStorage dataStorage, CobolFieldAttribute attribute) {
	...
	public CobolNumericField getNumericField() {
		CobolFieldAttribute attr = new CobolFieldAttribute(
			CobolFieldAttribute.COB_TYPE_NUMERIC_DISPLAY, 24, 12, CobolFieldAttribute.COB_FLAG_HAVE_SIGN, null);
