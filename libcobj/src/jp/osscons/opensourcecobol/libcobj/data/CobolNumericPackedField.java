...
public class CobolNumericPackedField extends AbstractCobolField {
	 ...
	 */
	public CobolNumericPackedField(int size, CobolDataStorage dataStorage, CobolFieldAttribute attribute) {
	...
	/**
	 * libcob/numeric.cのcob_set_packed_intの実装
	 * 引数で与えらえられたデータからthisへの代入を行う
	...
	/**
	 * libcob/numeric.cのcob_packed_get_signの実装
	...
	/**
	 * libcob/codegen.hのcob_add_packed_intの実装
	 * thisの保持する数値データに加算する
