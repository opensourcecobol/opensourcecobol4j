...
public class CobolResolve {
	 ...
	 */
	static private Map<String, CobolRunnable> callTable;
	/**
	 * ポインタ(UUID)のCobolRunnableインスタンスの対応表
	 */
	static private Map<UUID, String> pointerTable;
	/**
	 * 名前の変換方法(小文字か大文字)を示す変数
	 */
	static private int name_convert;
	/**
	 * デフォルトのパッケージ名
	 */
	static private String defaultPackageName;
	//TODO resolve_pathsの利用方法
	/**
	 * システムで設定された区切り文字で区切られた0個以上のパス
	 * 動的に読み込むクラスファイルを検索する場所を示す.
	 */
	static private List<String> resolve_paths;
	/**
	 * システムで設定された区切り文字で区切られた0個以上のパス
	 * 動的に読み込むクラスファイルを検索するパッケージ名を示す.
	 */
	static private List<String> package_paths;
	 ...
	 * 初期化を行う
	 */
	static public void CobolInitCall() {
...
//		}
	 ...
	 */
	static private void setLibraryPath(String path) {
	 ...
	 * @param path 区切り文字で区切られた0個以上のパスを示す文字列
	 */
	static private void setPackagePath(String path) {
	...
	static public void setCancel(String name, CobolRunnable runnable) {
	 ...
	 * @return
	 */
	static public CobolRunnable resolve1(String name) {
	 ...
	 */
	static private CobolRunnable getInstance(String name) {
		CobolRunnable runnable = null;
	 ...
	 */
	static public void cancel(AbstractCobolField cobolField) {
	 ...
	 * @param name プログラム名
	 */
	static public void cancel(String name) {
		if (name == null) {
	...
	/**
	 * プログラム名に対応するCobolRunnableのインスタンスに対応するポインタ(UUID)
	 * をバイト配列として返す
	 * @param name プログラム名
